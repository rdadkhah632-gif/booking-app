...
export const en: TranslationTree = {
  ...
  "nav.account": "Account",
  "nav.mobile.label": "Customer navigation",
  "nav.mobile.explore": "Explore",
  "nav.mobile.map": "Map",
  "nav.mobile.bookings": "Bookings",
  "nav.mobile.updates": "Updates",
  ...
  "privacy.section10.title": "10. Anonymous product analytics",
  "privacy.section10.body":
    "Mirëbook uses privacy-focused Vercel Web Analytics to understand anonymous page visits, devices, countries and referral sources. We also record a limited set of allowlisted actions, such as searches, place views, claim interest, registration attempts and booking starts, together with campaign labels from links. These analytics do not store names, email addresses, phone numbers, IP addresses, exact locations, account IDs or persistent browser identifiers. Mirëbook's own event reporting respects Do Not Track and Global Privacy Control signals.",
  ...
  "home.business.actionBody":
    "Approve new bookings and customer reschedule requests.",
  "home.business.managerTitle": "Calendar",
  "home.business.managerBody":
    "View confirmed, pending, completed and cancelled appointments.",
  ...
  "support.business.messagePlaceholder":
    "Explain the issue. Include service/staff names, booking details or screenshots context if relevant.",
  ...
  "support.business.setupHubBody":
    "Check profile, services, staff, hours and publish status.",
  "support.business.bookings": "Bookings",
  "support.business.bookingsBody":
    "Review confirmed, pending and completed bookings.",
  "support.business.services": "Services",
  "support.business.servicesBody":
    "Edit services, prices, durations and images.",
  "support.business.staff": "Staff",
  "support.business.staffBody":
    "Manage staff, service assignments and staff photos.",
  ...
  "myBookings.fallback.staffMember": "Assigned staff",
  ...
  "myBookings.card.pendingRequestTitle":
    "The business needs to approve your latest requested time before you can request another change.",
  ...
  "notifications.viewBooking": "View details",
  "notifications.reviewInMyBookings": "Review in My bookings",
  ...
  "notifications.viewBookings": "Open My bookings",
  "notifications.openMyBookings": "Open My bookings",
  ...
  "bookingConfirmation.heading.confirmed": "Booking confirmed",
  ...
  "bookingConfirmation.lead.confirmedStart": "You're booked with",
  ...
  "dashboardHome.summary.todayBody": "Confirmed appointments today",
  "dashboardHome.summary.actionRequired": "Action required",
  "dashboardHome.summary.bookingApproval": "appointment request",
  "dashboardHome.summary.rescheduleRequest": "reschedule request",
  "dashboardHome.summary.last30Days": "Last 30 days",
  "dashboardHome.summary.totalActivity": "Total appointment activity",
  ...
  "dashboardHome.pendingBookings": "Appointment requests",
  ...
  "dashboardHome.priority.bookingManager": "Calendar",
  ...
  "dashboardHome.analytics.body":
    "These figures are estimated from Mirëbook appointments and service prices.",
  ...
  "dashboardHome.analytics.completedRateBody":
    "Completed appointments / last 30 days activity",
  ...
  "dashboardHome.analytics.averageValue": "Average appointment value",
  "dashboardHome.analytics.averageValueBody":
    "Average listed service price in recent appointment activity",
  "dashboardHome.analytics.topService": "Top service",
  "dashboardHome.analytics.noData": "No data yet",
  "dashboardHome.analytics.booking": "appointment",
  "dashboardHome.analytics.bookings": "appointments",
  ...
  "dashboardHome.schedule.body": "Upcoming confirmed appointments.",
  ...
  "dashboardHome.schedule.oneBooking": "1 appointment",
  "dashboardHome.schedule.bookingCount": "{{count}} appointments",
  "dashboardHome.readiness.kicker": "Setup readiness",
  "dashboardHome.readiness.body":
    "Profile, services, staff and availability readiness",
  ...
  "dashboardHome.guidance.readyBody":
    "Customers can use the public booking flow based on your services, staff and availability.",
  ...
  "dashboardHome.guidance.body":
    "These checks help avoid customers seeing incomplete business information or unavailable booking slots.",
  ...
  "dashboardBusinesses.setupHub.body":
    "Keep your public profile, services, staff and availability ready so customers can book without confusion.",
  "dashboardBusinesses.setupHub.profile": "Business profile",
  "dashboardBusinesses.setupHub.profileBody":
    "Edit public details, image, category and publish status.",
  ...
  "dashboardBusinesses.readiness.assignmentFound":
    "active staff-service assignment",
  ...
  "dashboardServices.preview.descriptionFallback":
    "Add a short description to help customers understand this service.",
  ...
  "dashboardStaff.businessPicker.manageBody":
    "Manage staff, service assignments and availability for this business.",
  ...
  "dashboardStaff.stats.activeBody":
    "Staff visible for business setup and booking rules",
  ...
  "dashboardStaff.stats.unassignedBody":
    "Active staff without service assignments",
  ...
  "dashboardStaff.stats.activeServicesBody":
    "Services that need staff coverage",
  ...
  "dashboardStaff.invite.marked":
    "marked as invited. Ask them to register or log in with",
  "dashboardStaff.invite.linkBody":
    "Mirëbook will link the staff account when the email matches.",
  ...
  "dashboardStaff.assignments.noServices":
    "No active services found. Add active services before assigning staff.",
  ...
  "dashboardStaff.availability.bodyReady":
    "This staff member has availability rows. Check exact times in the availability page.",
  ...
  "account.accessBody":
    "Access is decided by your linked customer, business, staff and operator records.",
  ...
  "account.noBusinessProfileBody":
    "Create or join a business only when you are onboarding a real business.",
  ...
  "account.accountOnlyBody":
    "These settings belong to your login account. They do not change your business profile, services, staff or booking rules.",
  ...
  "dashboardBookings.recordsHeading": "Manage appointments",
  ...
  "dashboardBookings.loading": "Loading calendar...",
  "dashboardBookings.error.noAccess":
    "You do not have access to this business.",
  "dashboardBookings.error.load": "Could not load appointments.",
  ...
  "dashboardBookings.toolbar.refresh": "Refresh calendar",
  "dashboardBookings.summary.needsApproval": "Needs approval",
  "dashboardBookings.summary.pendingRequests": "Pending appointment requests",
  ...
  "dashboardBookings.summary.currentViewBody":
    "Appointments matching the filters",
  ...
  "dashboardBookings.empty.noBookingsTitle": "No appointments yet",
  "dashboardBookings.empty.noBookingsBody":
    "Customer appointments for this business will appear here once your public page is published and customers start booking.",
  ...
  "dashboardAnalytics.metrics.averageValue": "Average appointment value",
  ...
  "publicBusiness.notification.customerPendingMessage":
    "will review your booking request for",
  ...
  "register.staffInviteBody":
    "This email matches a staff invite. Your account will be linked after registration.",
  ...
  "register.noStaffInvite":
    "This staff account needs a valid staff invite before it can be created.",
  ...
  "register.business.timezoneLabel": "Timezone",
  "register.business.currencyLabel": "Currency",
  ...
  "staff.today.titleWithWork": "You have work scheduled today",
  "staff.today.titleNoWork": "No work scheduled today",
  "staff.today.nextDeparture": "Next departure",
  "staff.today.noUpcomingWork": "No assigned work coming up.",
  ...
  "dashboardHome.ownerStaffNote.title":
    "Only add yourself to Staff if customers can book you",
  ...
  "support.staff.troubleshooting.kicker": "Quick troubleshooting",
  ...
  "support.customer.guide.changeTitle": "Need to change a time",
  ...
  "support.customer.guide.notificationsTitle": "Missing notifications",
  ...
  "support.business.myMessages": "Business support messages",
  ...
  "support.business.viewConversation": "View conversation",
  "support.business.allConversations": "All support messages",
  ...
  "support.business.beforeSending.kicker": "Before sending",
  ...
  "support.business.operatorInbox": "Operator support inbox",
  "support.business.operatorInboxBody":
    "Visible only if your account is also an admin/operator account.",
  "support.business.guide.kicker": "Business support guide",
  "support.business.guide.setupTitle": "Setup or publishing issue",
  ...
  "support.business.guide.bookingTitle": "Customer booking issue",
  ...
  "support.customer.messageLabel": "Message",
  ...
  "support.customer.notificationsBody":
    "Check booking approvals, replies and Mirëbook updates.",
  "support.customer.exploreBody": "Find businesses and book another service.",
  "support.customer.accountBody":
    "Update your name, email, phone and language preference.",
  "support.customer.subject.pending": "Booking is still pending",
  "support.customer.subject.cancel": "I need help cancelling a booking",
  "support.customer.subject.noResponse": "The business has not responded",
  "support.customer.subject.wrongDetails": "My booking details look wrong",
  "support.customer.subject.account": "Account or login issue",
  "support.customer.subject.notifications": "Notification issue",
  "support.customer.subject.other": "Other customer issue",
  ...
  "support.messages.unknownDate": "Unknown date",
  "support.messages.kicker": "Support conversations",
  "support.messages.title": "My support messages",
  "support.messages.subtitle":
    "Track replies from Mirëbook support and continue conversations when more information is needed.",
  "support.messages.supportHub": "Support hub",
  "support.messages.loading": "Loading your support conversations...",
  "support.messages.openConversations": "Open conversations",
  "support.messages.openConversationsBody": "Waiting, open or in review",
  "support.messages.totalConversations": "Total conversations",
  ...
  "support.messages.goToSupportHub": "Go to support hub",
  "support.messages.requestFallback": "Support request",
  "support.messages.noPreview": "No message preview available.",
  "support.messages.created": "Created",
  "support.priority.normal": "Normal",
  "support.priority.high": "High",
  "support.priority.urgent": "Urgent",
  "support.thread.notFound": "Support conversation not found.",
  "support.thread.replySent": "Reply sent. Mirëbook support has been notified.",
  "support.thread.loading": "Loading support conversation...",
  "support.thread.kicker": "Support conversation",
  "support.thread.subtitle":
    "View replies from Mirëbook support and send follow-up information in the same conversation.",
  "support.thread.allMessages": "All messages",
  "support.thread.status": "Status",
  "support.thread.priority": "Priority",
  "support.thread.originalMessage": "Your original message",
  "support.thread.noMessageBody": "No message body provided.",
  "support.thread.mirebookSupport": "Mirëbook support",
  "support.thread.you": "You",
  "support.thread.resolvedConversation": "Resolved conversation",
  "support.thread.replyToSupport": "Reply to support",
  "support.thread.resolvedTitle": "This ticket is marked as resolved",
  "support.thread.resolvedBody":
    "Start a new support request if you need help with a different issue.",
  "support.thread.startNewRequest": "Start new support request",
  ...
  "billing.planStarterTitle": "Independent businesses",
  "billing.planStarterBody": "Early-stage businesses and solo operators.",
  "billing.planGrowth": "Growth",
  "billing.planGrowthTitle": "Growing teams",
  "billing.planGrowthBody": "Additional staff and higher booking volume.",
  "billing.planPro": "Pro",
  "billing.planProTitle": "Established businesses",
  "billing.planProBody": "Advanced tools and operational features.",
  ...
  "calendar.days.0": "Sunday",
  "calendar.days.1": "Monday",
  "calendar.days.2": "Tuesday",
  "calendar.days.3": "Wednesday",
  ...
  "notifications.actions.viewBooking": "View details",
  ...
  "dashboardLayout.nav.bookings": "Calendar",
  ...
  "explore.discovery.title": "Explore Albania",
  ...
  "explore.discovery.showingCount": "Showing {shown} of {total}",
  "explore.discovery.showMore": "Show more places",
  ...
  "explore.map.unavailableTitle": "Map view is unavailable",
  ...
  "explore.map.control.findLocation": "Find my location",
  "explore.map.control.locationUnavailable": "Location not available",
  "explore.map.control.mapboxHomepage": "Mapbox homepage",
  "explore.map.control.improveMap": "Improve this map",
  "explore.map.control.mapTitle": "Map",
  "explore.map.control.resetBearing": "Reset bearing to north",
  "explore.map.control.zoomIn": "Zoom in",
  "explore.map.control.zoomOut": "Zoom out",
  "explore.map.control.ctrlZoom": "Use ctrl + scroll to zoom the map",
  "explore.map.control.commandZoom": "Use ⌘ + scroll to zoom the map",
  "explore.map.control.touchPan": "Use two fingers to move the map",
  "directory.category.beauty_grooming": "Beauty and grooming",
  "directory.category.dental_health": "Dental health",
  "directory.category.wellness_fitness": "Wellness and fitness",
  "directory.category.events": "Events",
  "directory.category.learning_lessons": "Learning and lessons",
  "directory.category.tours_activities": "Tours and activities",
  "directory.category.rentals": "Rentals",
  "directory.category.attractions": "Attractions",
  "directory.category.food_drink": "Food and drink",
  "directory.category.lodging": "Accommodation",
  "directory.card.type": "Local place",
  "directory.card.albania": "Albania",
  "directory.card.notBookable": "Not bookable on Mirëbook yet",
  ...
  "admin.directory.overview": "Operator overview",
  ...
  "admin.directory.coverage.loading": "Loading launch coverage...",
  "admin.directory.media.kicker": "Visual catalogue",
  "admin.directory.media.title": "Marketplace photos",
  ...
  "admin.directory.media.loading": "Loading photo coverage...",
  "admin.directory.media.of": "of",
  "admin.directory.media.coverage": "approved places include a reviewed photo",
  "admin.directory.media.progressLabel": "Approved place photo coverage",
  "admin.directory.media.all": "All approved",
  "admin.directory.media.withPhoto": "With photo",
  "admin.directory.media.missing": "Photos needed",
  "admin.directory.media.photo": "Photo",
  "admin.directory.media.photoNeeded": "Photo needed",
  "admin.directory.media.gapsTitle": "Coverage gaps",
  "admin.directory.media.gapsBody":
    "Open a thin city or category to see only approved places still using fallback artwork.",
  "admin.directory.media.byCity": "By city",
  "admin.directory.media.byCategory": "By category",
  "admin.directory.media.priorityTitle": "Next balanced photo set",
  ...
  "admin.directory.media.openQueue": "Open full photo queue",
  "admin.directory.media.reason.city": "City coverage gap",
  "admin.directory.media.reason.category": "Category coverage gap",
  "admin.directory.media.reason.booking": "Strong booking fit",
  "admin.directory.media.reason.contact": "Contact route available",
  "admin.directory.media.reason.confidence": "High-confidence record",
  "admin.directory.statusSummary": "Directory status summary",
  "admin.directory.loadingSummary": "Loading directory summary...",
  "admin.directory.status.needsReview": "Needs review",
  "admin.directory.status.active": "Approved",
  "admin.directory.status.hidden": "Hidden",
  "admin.directory.status.closed": "Closed",
  "admin.directory.status.duplicate": "Duplicate",
  "admin.directory.category.beauty_grooming": "Beauty and grooming",
  "admin.directory.category.dental_health": "Dental health",
  "admin.directory.category.wellness_fitness": "Wellness and fitness",
  "admin.directory.category.events": "Events",
  "admin.directory.category.learning_lessons": "Learning and lessons",
  "admin.directory.category.tours_activities": "Tours and activities",
  "admin.directory.category.rentals": "Rentals",
  "admin.directory.category.attractions": "Attractions",
  "admin.directory.category.food_drink": "Food and drink",
  "admin.directory.category.lodging": "Accommodation",
  "admin.directory.action.approve": "Approve for discovery",
  "admin.directory.action.hide": "Hide place",
  "admin.directory.action.close": "Mark closed",
  "admin.directory.action.review": "Return to review",
  "admin.directory.action.duplicate": "Mark duplicate",
  "admin.directory.filter.search": "Place name",
  "admin.directory.filter.searchPlaceholder": "Search names",
  "admin.directory.filter.category": "Category",
  "admin.directory.filter.allCategories": "All categories",
  "admin.directory.filter.city": "City",
  "admin.directory.filter.cityPlaceholder": "Exact city",
  "admin.directory.filter.media": "Photo",
  "admin.directory.filter.allMedia": "Any photo status",
  "admin.directory.filter.apply": "Apply filters",
  "admin.directory.results": "results",
  "admin.directory.loading": "Loading directory places...",
  "admin.directory.emptyTitle": "No places in this view",
  "admin.directory.emptyBody":
    "Change the status or filters to review another group.",
  "admin.directory.previous": "Previous",
  "admin.directory.next": "Next",
  "admin.directory.selectTitle": "Select a place",
  "admin.directory.selectBody":
    "Choose a row to inspect source data and make a review decision.",
  "admin.directory.mapLoading": "Loading map...",
  "admin.directory.map": "Preview map",
  "admin.directory.mapAlt": "Map preview for this directory place",
  "admin.directory.address": "Address",
  "admin.directory.contact": "Source contact",
  "admin.directory.website": "Website",
  "admin.directory.sourceCategory": "Source category",
  "admin.directory.source": "Source",
  "admin.directory.confidence": "Source confidence",
  "admin.directory.operatingStatus": "Source operating status",
  "admin.directory.operating.operating": "Operating",
  "admin.directory.operating.temporarilyClosed": "Temporarily closed",
  "admin.directory.operating.permanentlyClosed": "Permanently closed",
  "admin.directory.claimStatus": "Claim status",
  "admin.directory.claim.unclaimed": "Unclaimed",
  "admin.directory.claim.claimed": "Claimed",
  "admin.directory.claim.disputed": "Disputed",
  "admin.directory.sourceUpdated": "Source updated",
  "admin.directory.lastImported": "Last imported",
  "admin.directory.provenance": "Source provenance",
  "admin.directory.latestReview": "Latest review",
  "admin.directory.reviewDecision": "Review decision",
  "admin.directory.canonicalId": "Canonical place ID",
  "admin.directory.notesOptional": "Review note (optional)",
  "admin.directory.notesRequired": "Review note",
  "admin.directory.notesPlaceholder":
    "Record what you checked or why this state is appropriate.",
  "admin.directory.saving": "Saving...",
  "admin.directory.confirm": "Confirm decision",
  ...
  "admin.directory.content.publicPreview": "View public page",
  "admin.directory.content.publicCrop": "Public card crop · 16:9",
  "admin.directory.content.readiness": "Photo readiness",
  "admin.directory.content.check.photo": "Reviewed image",
  "admin.directory.content.check.altEn": "English image description",
  "admin.directory.content.check.altSq": "Albanian image description",
  "admin.directory.content.check.credit": "Public credit",
  "admin.directory.content.check.rights": "Private rights record",
  ...
  "admin.directory.controlBody":
    "Review source data and decide which non-bookable places may appear in discovery.",
  "nav.claims": "Claims",
  "directory.card.details": "Details",
  "directory.card.reportPlace": "Report incorrect place details",
  "directory.profile.metaTitle": "Local place | Mirëbook",
  ...
  "directory.claim.status.moreInfo": "More information needed",
  ...
  "directory.claim.evidence.phone": "Business phone",
  ...
  "admin.claims.status.approved": "Approved",
  "admin.claims.status.rejected": "Rejected",
  "admin.claims.status.withdrawn": "Withdrawn",
  "admin.claims.results": "claims",
  "admin.claims.loading": "Loading claims...",
  "admin.claims.empty": "No claims in this view",
  "admin.claims.select": "Select a claim to review its evidence.",
  "admin.claims.unknownPlace": "Unknown place",
  "admin.claims.unknownBusiness": "Unknown business",
  "admin.claims.directoryPlace": "Directory place",
  "admin.claims.mirebookBusiness": "Mirëbook business",
  "admin.claims.claimant": "Claimant",
  "admin.claims.evidence": "Evidence",
  "admin.claims.noMaskedValue": "No additional stored value",
  "admin.claims.message": "Claimant explanation",
  "admin.claims.previousNote": "Review note",
  "admin.claims.published": "Published",
  "admin.claims.draft": "Draft",
  "admin.claims.approve": "Approve ownership",
  "admin.claims.moreInfo": "Request more information",
  "admin.claims.reject": "Reject claim",
  "admin.claims.confirmApprove": "Approve this ownership claim?",
  "admin.claims.confirmMoreInfo": "What should the owner provide?",
  "admin.claims.confirmReject": "Why is this claim being rejected?",
  "admin.claims.approveNote": "Optional internal review note",
  "admin.claims.ownerNote": "Clear note shown to the business owner",
  "admin.claims.confirm": "Confirm decision",
  "admin.claims.saving": "Saving...",
  "admin.claims.success": "Ownership claim review saved.",
  "admin.claims.error.load": "Ownership claims could not be loaded.",
  "admin.claims.error.note": "Add a note for the business owner.",
  ...
  "admin.outreach.adminOnly": "Admin access is required.",
  "admin.outreach.kicker": "Marketplace growth",
  ...
  "admin.outreach.status.planned": "Planned",
  "admin.outreach.status.contacted": "Contacted",
  "admin.outreach.status.followUp": "Follow up",
  "admin.outreach.status.interested": "Interested",
  "admin.outreach.status.declined": "Declined",
  "admin.outreach.status.unreachable": "Unreachable",
  "admin.outreach.due": "follow-ups due",
  "admin.outreach.openClaims": "open claims handled in ownership review",
  "admin.outreach.dueNow": "Due",
  "admin.outreach.filter.search": "Search",
  "admin.outreach.filter.searchPlaceholder": "Place, city or contact",
  "admin.outreach.filter.city": "City",
  "admin.outreach.filter.allCities": "All cities",
  "admin.outreach.filter.category": "Category",
  "admin.outreach.filter.allCategories": "All categories",
  "admin.outreach.filter.apply": "Apply",
  "admin.outreach.results": "candidates",
  "admin.outreach.loading": "Loading...",
  "admin.outreach.emptyTitle": "No candidates in this view",
  "admin.outreach.emptyBody":
    "Change the filters or open Directory review to prepare more places.",
  "admin.outreach.previous": "Previous",
  "admin.outreach.next": "Next",
  "admin.outreach.selectTitle": "Select a candidate",
  "admin.outreach.selectBody":
    "Choose a place to see contact routes and record the next step.",
  "admin.outreach.publicPlace": "Public place",
  "admin.outreach.contactTitle": "Contact routes",
  "admin.outreach.website": "Website",
  "admin.outreach.social": "Social",
  "admin.outreach.noContact":
    "No direct contact route is stored. Verify one in Directory review before outreach.",
  "admin.outreach.claimTitle": "Owner claim link",
  "admin.outreach.claimBody":
    "Share this only with an authorised owner. It opens Mirëbook Business and preserves this place.",
  "admin.outreach.claimLinkLabel": "Owner claim link",
  ...
  "admin.outreach.via": "Via",
  "admin.outreach.followUpShort": "Follow up",
  "admin.outreach.statusLabel": "Status",
  "admin.outreach.channelLabel": "Channel",
  "admin.outreach.channel.choose": "Choose channel",
  "admin.outreach.channel.email": "Email",
  "admin.outreach.channel.phone": "Phone",
  "admin.outreach.channel.social": "Social",
  "admin.outreach.channel.website": "Website form",
  ...
  "admin.outreach.noActivity": "No outreach activity recorded",
  "admin.outreach.success": "Private outreach update saved.",
  "admin.outreach.error.load": "The outreach queue could not be loaded.",
  "admin.outreach.error.save": "The outreach update could not be saved.",
  ...
  "nav.growth": "Growth",
  "admin.growth.metaTitle": "Growth analytics | Mirëbook",
  "admin.growth.kicker": "Launch signals",
  "admin.growth.title": "Growth analytics",
  "admin.growth.subtitle":
    "See how discovery, outreach and real account activity move toward bookings.",
  "admin.growth.period": "Period",
  "admin.growth.last7": "Last 7 days",
  "admin.growth.last30": "Last 30 days",
  "admin.growth.last90": "Last 90 days",
  "admin.growth.error": "Growth analytics could not be loaded. Try again.",
  "admin.growth.adminOnlyTitle": "Admin only",
  "admin.growth.adminOnly": "Admin access is required.",
  "admin.growth.storageTitle": "Interaction reporting is not active yet",
  ...
  "admin.growth.summary": "Growth summary",
  "admin.growth.interactions": "Tracked interactions",
  "admin.growth.interactionsBody": "Anonymous, allowlisted actions",
  "admin.growth.accounts": "New accounts",
  "admin.growth.customers": "customer",
  "admin.growth.businesses": "business",
  "admin.growth.staffLinked": "staff-linked",
  "admin.growth.bookings": "Bookings created",
  "admin.growth.bookingsBody": "Authoritative booking records",
  "admin.growth.claimInterest": "Claim interest",
  "admin.growth.claimInterestBody": "Business claim links opened",
  "admin.growth.funnelKicker": "Conversion",
  "admin.growth.funnelTitle": "From interest to action",
  "admin.growth.openVercel": "Open visitor analytics",
  "admin.growth.contentViews": "Place and business views",
  "admin.growth.registrationAttempts": "Registration submissions",
  "admin.growth.accountsCreated": "Accounts created",
  "admin.growth.bookingAttempts": "Booking submissions",
  "admin.growth.bookingsCreated": "Bookings created",
  ...
  "admin.growth.sources": "Acquisition sources",
  "admin.growth.noSources": "No attributed interactions yet.",
  "admin.growth.devices": "Devices",
  "admin.growth.noDevices": "No device activity yet.",
  "admin.growth.campaigns": "Campaigns",
  "admin.growth.noCampaigns": "No campaign activity yet.",
  "admin.growth.contentKicker": "Discovery",
  "admin.growth.topContent": "Most-viewed places and businesses",
  "admin.growth.bookableBusiness": "Bookable business",
  "admin.growth.noContent":
    "No place or business views have been recorded yet.",
  "admin.growth.dailyKicker": "Trend",
  "admin.growth.dailyTitle": "Latest 14 days",
  "admin.growth.legendInteractions": "Interactions",
  "admin.growth.legendAccounts": "Accounts",
  "admin.growth.legendBookings": "Bookings",
  "admin.growth.recent": "Recent interactions",
  "admin.growth.noRecent": "No recent interactions yet.",
  "admin.growth.controlKicker": "Launch intelligence",
  "admin.growth.controlTitle": "Understand what is gaining interest",
  "admin.growth.controlBody":
    "Compare discovery activity, campaign sources, account creation and bookings without exposing visitor identities.",
  "admin.growth.event.homeSearch": "Homepage search",
  "admin.growth.event.homeSuggestion": "Homepage suggestion selected",
  "admin.growth.event.homeMap": "Homepage map opened",
  "admin.growth.event.businessEntry": "Business entry opened",
  "admin.growth.event.exploreSearch": "Explore search",
  "admin.growth.event.exploreSuggestion": "Explore suggestion selected",
  "admin.growth.event.viewChanged": "List or map changed",
  "admin.growth.event.kindChanged": "Result type changed",
  "admin.growth.event.mapSelection": "Map result selected",
  "admin.growth.event.moreResults": "More results opened",
  "admin.growth.event.locationRequested": "Nearby requested",
  "admin.growth.event.locationResolved": "Nearby result",
  "admin.growth.event.placeViewed": "Local place viewed",
  "admin.growth.event.websiteOpened": "Place website opened",
  "admin.growth.event.directionsOpened": "Directions opened",
  "admin.growth.event.claimOpened": "Business claim opened",
  "admin.growth.event.businessViewed": "Bookable business viewed",
  "admin.growth.event.bookingStarted": "Booking submitted",
  "admin.growth.event.registrationViewed": "Registration viewed",
  "admin.growth.event.registrationSubmitted": "Registration submitted",
  ...
  "customerApp.lifecycle.reschedule.businessTitle": "Reschedule request",
