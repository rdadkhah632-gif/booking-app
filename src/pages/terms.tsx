...
export default function TermsPage() {
  ...
  return (
    <main className="marketplace-surface customer-legal-surface">
      ...
      <section className="container customer-legal-container">
        <div className="legal-shell">
          ...
          <div className="card legal-content">
            ...
            <p>{t("terms.section6.body2")}</p>

            <h2>{t("terms.section7.title")}</h2>
            <p>{t("terms.section7.body1")}</p>
            <p>{t("terms.section7.body2")}</p>
