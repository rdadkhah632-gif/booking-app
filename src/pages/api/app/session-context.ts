...
function appTabs(context: AppContext) {
...
export function appSessionContextResponse(context: AppContext) {
...
export default async function handler(
  ...
  try {
    ...
    return res.status(200).json(appSessionContextResponse(context));
  } catch (error) {
