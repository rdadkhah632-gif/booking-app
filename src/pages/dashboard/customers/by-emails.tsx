...
export default function CustomerByEmailPage() {
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: 260 }}>
            ...
            >
              <strong>
                {booking.services?.name || "Service not recorded"}
              </strong>
  ...
  return (
    <DashboardLayout
      ...
      subtitle={
        selectedBusiness
          ? `Customer history for ${selectedBusiness.name}`
          : "Customer booking history found by email."
      }
    >
      {pageLoading && (
        <div className="card">
      ...
      {!pageLoading && bookings.length === 0 && businesses.length > 0 && (
        <div className="card">
          ...
          <p className="muted" style={{ marginTop: "0.5rem" }}>
            No booking history was found for this email address in the selected
            business scope.
          </p>
          <Link
        ...
        <div style={{ display: "grid", gap: "1.5rem" }}>
          ...
          >
            <p className="small" style={{ color: "var(--warning)" }}>
              Email-matched customer
            </p>
            <strong>
              This history is matched by email, not by account ID.
            </strong>
            <p className="small muted" style={{ marginTop: "0.35rem" }}>
              If the customer later books while logged into a registered
              account, their account profile can be opened directly from future
              bookings.
            </p>
          </div>
          ...
          <div className="grid-2">
            <div className="card">
              ...
              <p className="muted small">
                All booking activity found for this email
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="muted small">
                Estimated from completed appointment prices
              </p>
            </div>
            ...
            <div className="card">
              ...
              {stats.nextAppointment ? (
                <>
                  ...
                  <Link
                    href={`/dashboard/bookings?businessId=${stats.nextAppointment.business_id}`}
                    className="btn btn-ghost"
                    style={{ marginTop: "1rem" }}
                  >
                    {t("dashboardBookings.businessPicker.cta", "Open calendar")}
              ...
              {stats.lastAppointment ? (
                <>
                  ...
                  <p
                    className="small"
                    style={{
                      color: statusColor(stats.lastAppointment.status),
                      marginTop: "0.45rem",
                    }}
                  >
