...
export default function CustomerDetailPage() {
  ...
  return (
    <DashboardLayout
      ...
      subtitle={selectedBusiness ? `Customer history for ${selectedBusiness.name}` : 'Customer booking history across your business profiles.'}
    >
      {pageLoading && (
        <div className="card">
      ...
      {!pageLoading && bookings.length === 0 && businesses.length > 0 && (
        <div className="card">
          ...
          <p className="muted" style={{ marginTop: '0.5rem' }}>
            This customer has no bookings for the selected business scope, or the booking record does not include a customer account ID.
          </p>
        ...
        <div style={{ display: 'grid', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', alignItems: 'flex-start' }}>
              <div>
                ...
                <div style={{ display: 'grid', gap: '0.25rem', marginTop: '0.65rem' }}>
                  ...
                  <p className="small muted">Customer ID: {Array.isArray(customerId) ? '' : customerId}</p>
                </div>
              </div>
          ...
          <div className="grid-2">
            <div className="card">
              ...
              <h3>{stats.total}</h3>
              <p className="muted small">All booking activity for this customer</p>
            </div>
