      ...
      <div className="settings-picker-header">
        <div>
          <p className="small muted">
            {t(
              "dashboardSettings.businessPicker.kicker",
              "Multiple businesses",
            )}
          </p>
          ...
          >
            {t("dashboardSettings.businessPicker.title", "Choose a business")}
          </h2>

          <p className="small muted" style={{ marginTop: "0.35rem" }}>
            {t(
              "dashboardSettings.businessPicker.body",
              "Each business has its own appointment rules and customer policy wording.",
            )}
          </p>
        </div>

        <Link href="/dashboard/businesses" className="btn btn-ghost">
          {t("dashboardSettings.manageBusinesses", "Open setup")}
        </Link>
      </div>
