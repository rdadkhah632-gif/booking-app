        ...
        >
          <div className="customer-notification-card-row">
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              >
                <p className="small muted">{t('notifications.requestedAppointmentTime', 'Requested appointment time')}</p>
                <strong>{new Date(booking.start_at).toLocaleString()}</strong>
                <p className="small muted" style={{ marginTop: '0.3rem' }}>
                  {t('notifications.reservedWhileWaiting', 'This time is reserved while waiting for business approval.')}
                </p>
              </div>
            </div>
